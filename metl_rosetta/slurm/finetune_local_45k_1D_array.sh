#!/bin/bash
#SBATCH --job-name=finetune_local_45k_1D
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/pn67na/pn67na-dss-0000/ge28jel2/fopra/metl_rosetta/logs/finetune_local_45k_1D_%A_%a.log
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/pn67na/pn67na-dss-0000/ge28jel2/fopra/metl_rosetta/logs/finetune_local_45k_1D_%A_%a.err
...
PRETRAINED_CKPT=$(cat /workspace/metl_rosetta/source_model_45k_1D/best_ckpt.txt)
...
echo "=== Finetune METL-Local 1D 45k: ${SEG} ==="
echo "Node: $(hostname)"
echo "Start: $(date)"
...
python3 code/train_target_model_pl2.py \
    ...
    --batch_size 64 \
    --no_use_wandb \
    --experiment "his3_${SEG}_local_45k_1D" \
    --log_dir_base /workspace/metl_rosetta/target_model_45k_1D
