#!/bin/bash
#SBATCH --job-name=ft45k_v2_S05sw
#SBATCH --output=/dss/dssfs02/lwp-dss-0001/pn67na/pn67na-dss-0000/ge28jel2/fopra/metl_rosetta/logs/finetune_local_45k_v2_S05swap_%j.log
#SBATCH --error=/dss/dssfs02/lwp-dss-0001/pn67na/pn67na-dss-0000/ge28jel2/fopra/metl_rosetta/logs/finetune_local_45k_v2_S05swap_%j.err
...
echo "=== Finetune METL-Local 45k v2 (backbone): S05_swap ==="
echo "Node: $(hostname)"
echo "Start: $(date)"
...
python3 code/train_target_model_pl2.py \
    ...
    --es_patience 20 \
    --no_use_wandb \
    --experiment "his3_S05_swap_local_45k_v2" \
